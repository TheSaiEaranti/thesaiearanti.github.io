...
const PA_RESUME = {
  ...
  phone: '(512) 635-7266',
  linkedin: 'linkedin.com/in/sai-preetam-earanti-580717285/',
            ...
            <div key={cat} className="pa-skill-row">
              ...
              <div className="pa-skill-items">
                {items.map((it) => {
                  ...
                  const url = `https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/${it.slug}/${it.slug}-${variant}.svg`;
                  return (
      ...
      <PASection id="contact" kicker="05 · contact" title="Let&rsquo;s talk.">
        <div className="pa-contact">
          ...
          <div className="pa-contact-links">
            <a href={`https://www.linkedin.com/in/sai-preetam-earanti-580717285/`} target="_blank" rel="noreferrer">
